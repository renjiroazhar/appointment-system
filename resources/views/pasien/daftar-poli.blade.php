                ...
                <div class="row justify-content-center">
                    <div class="card p-0">
                        <div class="card-header bg-primary text-white">
                            <h3 class="card-title text-bold text-center mt-2">
                                Daftar Poli
                            </h3>
                        </div>
                        <form action="{{ route('pasien.daftarpoli.store') }}" method="POST">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group mt-2">
                                    ...
                                    <textarea class="form-control" name="keluhan" id="keluhan" cols="1" rows="1"
                                        placeholder="Tulis Keluhan"></textarea>
                                </div>
                            ...
                            <div class="card-footer d-flex justify-content-between">
                                <div>
                                    <button type="submit" class="btn btn-primary">Simpan <i class="bi bi-check-circle"></i></button>
    ...
    <script>
        $('#id_poli').on('change', function() {
            ...
            $.get('/getJadwals', {
                ...
                if (data.length === 0) {
                    $('#id_jadwal').append('<option>Belum ada jadwal</option>');
                }
