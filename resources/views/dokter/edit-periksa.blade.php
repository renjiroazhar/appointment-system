            ...
            <div class="card-body">
                ...
                <form action="{{ route('editperiksa.update', ['id' => $daftarPoli->id]) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="nama" name="nama" value="{{ $daftarPoli->pasien->nama }}" required disabled>
                        <input type="hidden" class="form-control" id="id" name="id_daftar_poli" value="{{ $daftarPoli->id }}">
                    </div>
                    ...
                    <input type="hidden" name="biaya_periksa" id="biaya_periksa" value="">
                    <div class="mt-3">
            ...
            <div class="modal-body">
                <form>
                    ...
                    <div class="mb-3">
                        ...
                        <input min="1" value="1" type="number" class="form-control" id="quantity" required>
                    </div>

                    <button type="button" data-dismiss="modal" class="btn btn-primary" onclick="addObatToList()">Add</button>
                </form>
            </div>
        </div>
    </div>
